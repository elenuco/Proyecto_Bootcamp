...
class EstudianteController extends Controller
{
    ...
    {
        $estudiante =Estudiante::select('id_estudiante', 'nie', 'nombre','apellido','fecha_nacimiento', 'genero', 'foto', 'telefono', 'usuario.correo AS correo', 'grado.grado_academico AS grado', 'institucion.nombre_institucion AS institucion')
    ...
    public function obtener(Request $request, $id_estudiante)
    {
       ...
       ->select('id_estudiante', 'nie', 'nombre','apellido','fecha_nacimiento', 'genero', 'foto', 'telefono', 'usuario.correo AS correo', 'grado.grado_academico AS grado', 'institucion.nombre_institucion AS institucion')
       ->join('usuario', 'estudiante.usuario_id', '=', 'usuario.id_usuario')
       ->join('grado', 'estudiante.grado_id','=', 'grado.id_grado')
       ->join('institucion', 'estudiante.institucion_id', '=', 'institucion.id_institucion');
